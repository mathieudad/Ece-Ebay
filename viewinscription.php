      ...
      <div class="user_card">
        ...
        <div class="d-flex justify-content-center form_container">
          <form action="traitementInscription.php" method="post">
            ...
            <h4 style="font-weight:bold;color:black">Votre Adresse</h4>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
              ...
              <input type="number" name="codepostal" class="form-control " placeholder="Code postal">
            ...
            <h4 style="font-weight:bold;color:black">Vos Informations de paiement</h4>


              <div>
              <label for="pays-select">Votre type de carte :</label>
              <select id="pays-select" class="form-control" name="typecarte" title="Pays">
                  <option>Visa</option>
              ...
              <div class="input-group mb-3 mt-3">
                <input type="text" name="nomcarte" class="form-control" placeholder="Nom sur la carte" >
              </div>
              <div class="input-group mb-3 mt-3">
                <input type="text" name="numcarte" class="form-control" placeholder="Numero de votre carte" >
              </div>

              <div class="input-group mb-3">
                <input type="text" name="dateExpi" class="form-control" placeholder="Date d'expiration de votre carte, exemple : 08/20">
              </div>
              <div class="input-group mb-3 mt-3">
                <input type="number" name="crypto" class="form-control" maxlength="3" minlength="3"  placeholder="Code de sécurité, il s'agit des 3 chiffres au dos de votre carte">
              </div>

              <div class="input-group mb-3 mt-3">
                <input type="number" name="portemonnaie" class="form-control" placeholder="Montant de votre porte-monnaie" >
              </div>
              <hr>
              <div class="input-group ">
                  <input type="submit" class="btn btn-outline-dark text-uppercase" value="Créer votre compte">
              </div>
                <hr>
            </form>
