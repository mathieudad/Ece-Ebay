		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<form  action="traitementValiderNegoClient.php" method="post">
						<?php
						$error=isset($_GET["error"])? $_GET["error"] : "";
						if($error==1)
							echo '<div class="title mb-2" style="color:red"> Type de Carte Incorrect </div>';
						elseif($error==2)
							echo '<div class="title mb-2" style="color:red"> nom de carte Incorrect </div>';
						elseif($error==3)
							echo '<div class="title mb-2" style="color:red"> nom de carte Incorrect </div>';
						elseif($error==4)
							echo '<div class="title mb-2" style="color:red"> infos personnelles Incorrectes </div>';
						elseif($error==5)
							echo '<div class="title mb-2" style="color:red"> Fonds Insiffisants </div>';
						...
						<div class="input-group mb-1">
							...
							<div class="input-group mb-3">
								<input type="number" name = "DateExpCarte" class="form-control input_user" placeholder="Date d'expiration, ex : 12/2020">
							</div>

							<div class="input-group mb-3">
								<input type="number" nom= "CodeCarte" class="form-control input_user" placeholder="Cryptogramme de sécurité">
							</div>
