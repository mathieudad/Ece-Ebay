...
<div> <a href="#"><img src="archi.jpg" height="720" width="458"></a></div>
</div> <!-- slider-product.// -->
...
<span class="price h3 text-warning">
  <span class="currency">EUR €</span><span class="num">1 299 </span>
</span>

</p>
<a href="#" class="btn btn-lg btn-outline-dark text-uppercase"> <i class="fas fa-shopping-cart"></i> Ajouter au panier </a>
<hr>
<dl class="param param-feature">
<dt>Prix actuel d'enchère</dt>
</dl>  <!-- item-property-hor .// -->

<p class="price-detail-wrap">
<span class="price h3 text-success">
  <span class="currency">EUR €</span><span class="num">800</span>
</span>
